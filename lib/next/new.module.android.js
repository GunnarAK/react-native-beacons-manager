...
const DummyHeadlessTask = async () => {
  console.log("DummyHeadlessTask");
};
AppRegistry.registerHeadlessTask('beacons-monitor-transition', () => DummyHeadlessTask);
...
function init(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.init(resolve, reject);
  });
}

function stop(): Promise<any> {
  return new Promise((resolve, reject) => {
    BeaconsManager.stop(resolve, reject);
  });
}
